...
- Enforced by [`check-coverage.sh`](../reference/scripts/check-coverage.md).
...
- [`run-all.sh` reference](../reference/scripts/run-all.md) — how to run the four Mago phases everywhere at once.
