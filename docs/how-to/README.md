...
| [**Release a component**](release-a-component.md) | I'm ready to ship `waffle-commons/security@0.1.0-beta6`. What's the process? |
...
| "We're ready to tag 0.1.0-beta6." | [Release a component](release-a-component.md) → [Bump submodule pointers](bump-submodule-pointers.md). |
